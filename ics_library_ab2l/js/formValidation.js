	...
	function validateFname(){
		...
		else if (!str.match(/^[A-Za-z|\.|\-|ñ|Ñ|\s]{2,50}$/))  msg+="Must be between 2-50 capital alpha character!<br/>";
	...
	function validateMinitial(){
		...
		else if (!str.match(/^[A-Z|Ñ]{1,3}$/))  msg+="Must be between 1-3 alpha characters.<br/>";
		else if(msg="Invalid input") msg="";
